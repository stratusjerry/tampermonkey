// ==UserScript==
// @name         kubernetes-docs dark
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Make kubernetes-docs dark
// @author       You
// @match        https://kubernetes.io//*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=kubernetes.io
// @grant        none
// ==/UserScript==
...
allElements.forEach(element => {
  if (getComputedStyle(element).color === 'rgb(73, 80, 87)') {
